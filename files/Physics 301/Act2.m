...
patch8 = readmatrix("MacbethPatch17.txt");
...
%%
num_red = ls_d65(:,2).*patch8(:,2).*cam_red_interp(:);
...
%%
num_green = ls_d65(:,2).*patch8(:,2).*cam_green_interp(:);
...
%%
num_blue = ls_d65(:,2).*patch8(:,2).*cam_blue_interp(:);
